...
public class SpringConfiguration {
	...
	@Bean
		...
		{
			InternalResourceViewResolver i = new InternalResourceViewResolver();    //view resolver
			i.setSuffix(".jsp");
	...
	public LocalSessionFactoryBean sessionFactory()
	{
		...
		sessionfactory.setHibernateProperties(getHibernamteProp());
		sessionfactory.setPackagesToScan("com.tqpp.model");
		return sessionfactory;
		}
	
	public Properties getHibernamteProp()
	{
