...
public class Mapdemo {
	...
	public static void mian(String args[]) {
		/*
		 * System.out.println("Start"); Configuration cfg = new Configuration();
		 ...
		 * 
		 * //create question Question q1= new Question(); q1.setQuestionid(1212);
		 * q1.setQuestion("What is youe name?");
		 * 
		 * System.out.println("####"+q1); //create Answer Answer answer= new Answer();
